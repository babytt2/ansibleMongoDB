...
"""
Add:
    Version check added from 3.6 to 4.0 (pymongo 3.6~3.7)
"""
def check_compatibility(module, client):
    ...
    if LooseVersion(srv_info['version']) >= LooseVersion('4.0') and LooseVersion(PyMongoVersion) < LooseVersion('3.7'):
        module.fail_json(msg='Note: you must use pymongo 3.7+ with MongoDB 4.0.x')
